...
def parse_args():
    ...
    parser.add_argument('--prototxt',dest='prototxt',help='prototxt filepath', type=str, default='./app/model/colorization_deploy_v2.prototxt')
    parser.add_argument('--caffemodel',dest='caffemodel',help='caffemodel filepath', type=str, default='./app/model/colorization_release_v2.caffemodel')
...
if __name__ == '__main__':
    ...
    pts_in_hull = np.load('./app/resources/pts_in_hull.npy') # load cluster centers
